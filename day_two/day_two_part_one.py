...
trail_scores: dict[str, int] = {'AX': 3, 'AY': 6, 'AZ': 0, 'BX': 0, 'BY': 3, 'BZ': 6, 'CX': 6, 'CY': 0, 'CZ': 3}
weapon_scores: dict[str, int] = {'X': 1, 'Y': 2, 'Z': 3}

def rock_paper_scissor(opponent: str, you: str) -> int:
    return trail_scores.get(opponent + you, 0) + weapon_scores.get(you, -999)
